...
- **Action**: Remove any code blocks in [`./scripts/release.sh`](./scripts/release.sh) that invoke `python3 aur/maintenance_aur.py`.
...
1. **Edit** [`./scripts/release.sh`](./scripts/release.sh):
